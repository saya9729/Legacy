...
var SAVE_FILES: String = "res://save/savefolder"
var SAVE_NAME_TEMPLATE: String = "save_%04d.tres"
...
func save(id: int):
	...
	if not directory.dir_exists(SAVE_FILES):
		directory.make_dir_recursive(SAVE_FILES)

	var save_path = SAVE_FILES.plus_file(SAVE_NAME_TEMPLATE % id)
...
func load(id: int):
	...
	var save_file_path: String = SAVE_FILES.plus_file(SAVE_NAME_TEMPLATE % id)
